local SerplexModules = {}
SerplexModules['Material'] = {
...
SerplexModules['Phosphor_Filled'] = {
...
function SerplexModules:GetIcon(name, source)
	source = source or "Symbols"
	game:GetService("ContentProvider"):PreloadAsync({`rbxassetid://{SerplexModules[source][name]}`})
	return SerplexModules[source][name]
end

return SerplexModules
